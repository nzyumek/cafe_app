...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { cafe_list_id: @info.cafe_list_id, content: @info.content } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { cafe_list_id: @info.cafe_list_id, content: @info.content } }
