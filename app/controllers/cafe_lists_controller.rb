class CafeListsController < ApplicationController
  ...
  private
    ...
    def cafe_list_params
      params.require(:cafe_list).permit(:title, :bean, :location, :url, :info, :access, :prefecture, :ward, :parking, :openingtime, :dayoff, :firsttel, :midtel, :lasttel, :envir, :wifi, :reservation, cafe_list_images: [], beantag_ids: [] )
    end
